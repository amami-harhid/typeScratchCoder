import{t as e}from"../typescratcher-BUWh1rf3.js";import{t}from"../water-CEakD2Ci.js";import{t as n}from"../front_01-U3UKDq96.js";var r=`
<div id="virtualPad">
    <div class="d-pad">
...
`,a=()=>{e.VirtualPad.addVirtualPad(r,i),e.VirtualPad.setupTouchButton(`btnUp`,e.Keyboard.UP),e.VirtualPad.setupTouchButton(`btnDown`,e.Keyboard.DOWN),e.VirtualPad.setupTouchButton(`btnLeft`,e.Keyboard.LEFT),e.VirtualPad.setupTouchButton(`btnRight`,e.Keyboard.RIGHT),e.VirtualPad.setupTouchButton(`btnA`,`A`),e.VirtualPad.setupTouchButton(`btnB`,`B`)},o=new e.Image({dogPng:n}),s=new e.Image({WaterSvg:t});a();var c=new e.Sprite(`shark`);c.Costume.add(o),c.Looks.size.scale=[30,30],c.Motion.position.xy=[0,-130],new e.Stage().Backdrop.add(s);var l=e.Variable.string(``);e.Variable.monitoring({ジャンプ:l}),c.Event.flagPresser().func=async function*(){this.Motion.position.xy=[0,-130],this.Motion.rotation.style=e.Rotation.LEFT_RIGHT;let t=1;for(;;)this.Sensing.edge.isTouchingVirtical&&(t*=-1),this.Motion.position.x+=10*t,yield},c.Event.keyPresser(`a`).func=async function*(){l.text=`等速`,l.show(),this.Motion.position.y=-130;for(let t of e.Loop.Iterator(10))this.Motion.position.y+=10,yield;for(let t of e.Loop.Iterator(10))this.Motion.position.y-=10,yield;l.hide(),l.text=``},c.Event.keyPresser(`b`).func=async function*(){l.text=`放物風`,l.show();let e=30;for(this.Motion.position.y=-130;;){if(e-=4,this.Motion.position.y+e<-130){yield;break}this.Motion.position.y+=e,yield}this.Motion.position.y=-130,l.hide(),l.text=``},e.engine.start();
//# sourceMappingURL=005-BinLq0z3.js.map