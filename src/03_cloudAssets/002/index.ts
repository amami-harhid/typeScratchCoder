...
// 【画像読み込み】
const Ballerina_a = "https://cdn.assets.scratch.mit.edu/internalapi/asset/5197d3778baf55da6b81b3ada1e10021.svg/get";
...
const Ballerina_c = "https://cdn.assets.scratch.mit.edu/internalapi/asset/fc02bf591dd3d91eeeb50c7424d08274.svg/get";
const BallerinaCImage = new Ts.Image( {Ballerina_c} );
const Ballerina_d = "https://cdn.assets.scratch.mit.edu/internalapi/asset/5aae21aee33c3f1ae943af5ea11254bf.svg/get";
const BallerinaDImage = new Ts.Image( {Ballerina_d} );
const Party = "https://cdn.assets.scratch.mit.edu/internalapi/asset/108160d0e44d1c340182e31c9dc0758a.svg/get";
const PartyImage = new Ts.Image( {Party} );

// 【音読み込み】
const AElecBass = "https://cdn.assets.scratch.mit.edu/internalapi/asset/5cb46ddd903fc2c9976ff881df9273c9.wav/get";
const AElecBassSound = new Ts.Sound( {AElecBass} );
const ABass = "https://cdn.assets.scratch.mit.edu/internalapi/asset/c04ebf21e5e19342fa1535e4efcdb43b.wav/get";
...
ballerina.Event.flagPresser().func = async function*(this: Sprite) {
    ...
    for(;;){
        ...
        this.Sound.play( Sounds[ Ts.Utils.randomValue(0, Sounds.length-1) ] );
